...
import type { QuestionSet as _QuestionSet, User as _User, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addShopBlook(arg0: string, arg1: bigint, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addShopBlook(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async buyBlook(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.buyBlook(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getQuestionSet(arg0: bigint): Promise<QuestionSet | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getQuestionSet(arg0);
    ...
    async getShopBlooks(): Promise<Array<[string, Blook]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getShopBlooks();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async giveCoins(arg0: Principal, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.giveCoins(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchQuestionSets(arg0: string): Promise<Array<QuestionSet>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchQuestionSets(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitQuestionSet(arg0: string, arg1: Array<Question>): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitQuestionSet(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_QuestionSet]): QuestionSet | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        xp: value.xp,
        name: value.name,
        equippedBlook: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.equippedBlook)),
        coins: value.coins,
        ownedBlooks: value.ownedBlooks
    };
}
...
function to_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        xp: value.xp,
        name: value.name,
        equippedBlook: value.equippedBlook ? candid_some(value.equippedBlook) : candid_none(),
        coins: value.coins,
        ownedBlooks: value.ownedBlooks
    };
}
